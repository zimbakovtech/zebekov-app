...
const locations = [
  {
    ...
    mapEmbed: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2965.0824050173574!2d21.433108315545!3d41.99646597922131!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1354149f0000000%3A0x0!2zNDHCsDU5JzQ3LjMiTiAyMcKwMjYnMDMuMiJF!5e0!3m2!1sen!2smk!4v1234567890123!5m2!1sen!2smk',
    features: ['Digital X-Ray', 'Modern Equipment', 'Comfortable Waiting Area', 'Wheelchair Accessible'],
  },
  {
    id: 2,
    name: 'Ohrid Branch',
    ...
    mapEmbed: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2965.0824050173574!2d20.801168315545!3d41.11646597922131!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1354149f0000000%3A0x0!2zNDHCsDU5JzQ3LjMiTiAyMcKwMjYnMDMuMiJF!5e0!3m2!1sen!2smk!4v1234567890123!5m2!1sen!2smk',
    features: ['Scenic Lake View', 'Tourist-Friendly', 'Modern Facilities', 'Emergency Services'],
  },
];
        ...
        <div className="relative container-custom text-center">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-200">Locations</span>
            </h1>
            <p className="text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed">
              Visit us at our convenient locations in Skopje and Ohrid.
                ...
                <div className={`space-y-8 ${index % 2 === 1 ? 'lg:col-start-1 lg:row-start-1' : ''}`}>
                  <div>
                    ...
                    <p className="text-lg text-gray-600 leading-relaxed">
                      Experience exceptional dental care at our {location.name.toLowerCase()} location.
                      Our modern facility is equipped with the latest technology to ensure
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start space-x-3">
                        <CarIcon className="h-6 w-6 text-[#44B0B6] mt-1" />
                        <div>
